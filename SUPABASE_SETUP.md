...
- **Project URL:** `https://tmrlpfjjczwvrahisslp.supabase.co`
- **Dashboard:** https://supabase.com/dashboard/project/tmrlpfjjczwvrahisslp
...
4. Add the following **Authorized Redirect URI**:
   ```
   https://tmrlpfjjczwvrahisslp.supabase.co/auth/v1/callback
   ```
...
1. Open https://supabase.com/dashboard/project/tmrlpfjjczwvrahisslp/auth/providers
...
https://supabase.com/dashboard/project/tmrlpfjjczwvrahisslp/auth/url-configuration:
